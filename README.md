...
* **🌌 Design 100% Dark Cyberpunk v2.0 (Neon Blue & Ícone 3D)**: Ditadura visual do modo escuro absoluto vibrando em Ciano Ciber (`#00f0ff`), com o novo ícone 3D em estilo terminal cibernético, barra lateral retrátil fluida e monitor ISP Dual Stack (IPv4/IPv6).
* **🔍 Rastreio Forense CGNAT (Integração Graylog v2.0)**: Módulo especializado de auditoria e interrogatório de IPs públicos/privados transladados (BPA / RFC 6598) em clusters Graylog. Extração direta de relatórios forenses executivos em **PDF nativo** e **TXT autenticado** com assinatura digital **SHA-256** e conformidade normativa **Marco Civil da Internet** e **LGPD**.
