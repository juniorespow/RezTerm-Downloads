# ⚡ RezTerm v2.1.1 (Cyberpunk SOC/NOC & Forensics PCAP Suite - Telecom Edition)
...
Desenvolvida por **Reginaldo Junior (Razon)** combinando a performance nativa do Windows (.NET 10 WPF / ReadyToRun Native) com uma interface ultramoderna Blazor Hybrid em estética **Cyberpunk Dark Neon** e motor de **Aceleração de Hardware Híbrida (GPU + SIMD)**.
...
## 📥 1. Como Baixar e Instalar (Release v2.1.1)
...
Na primeira execução do **RezTerm v2.1.1**, o sistema iniciará em **Tela Cheia Maximizada** apresentando a tela modal de bloqueio de segurança:
...
## 🛠️ 3. Suíte de Ferramentas Integradas (v2.1.1)
